...
if is_module_loaded(FILENAME):
    ...
    from Ravanbot import EVENT_LOGS, LOGGER, dispatcher
    from Ravanbot.modules.helper_funcs.chat_status import user_admin
    from Ravanbot.modules.sql import log_channel_sql as sql
