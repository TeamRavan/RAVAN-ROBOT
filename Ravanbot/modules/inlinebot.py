...
from Ravanbot.function.inlinehelper import *
from Ravanbot.function.pluginhelpers import fetch, json_prettify
from Ravanbot.services.pyrogram import pbot as app
...
__MODULE__ = "Inline"
__HELP__ = """
 ==>> **INLINE BOT SERVICE OF** @RAVANTHEKAAL_PROBOT <<==
`I'm more efficient when added as group admin. By the way these commands can be used by anyone in a group via inline.`
   >> Using <<
@RAVANTHEKAAL_PROBOT [command] [query]
   >> Commands Available <<
