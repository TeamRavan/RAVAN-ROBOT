...
from Ravanbot import BOT_USERNAME, OWNER_ID
from Ravanbot.config import get_str_key
from Ravanbot.function.pluginhelpers import convert_seconds_to_minutes as time_convert
from Ravanbot.function.pluginhelpers import fetch
from Ravanbot.services.pyrogram import pbot
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/RavanTheKaal_probot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )
...
**Profiles:** [BOT](t.me/RavanTheKaal_probot) | [UBOT](t.me/PATRICIA_SUPPORT)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/c0bac10b7d0ff071f8537.jpg",
