...
from Ravanbot.modules import ALL_MODULES
from Ravanbot.modules.helper_funcs.chat_status import is_user_admin
from Ravanbot.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """Hello, My name is [✪𝐑𝐀𝐕𝐀𝐍✪](https://telegra.ph/file/3f3e6a5ed0a70b8f8b144.jpg)
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ 𝐀𝐃𝐃 ✪𝐑𝐀𝐕𝐀𝐍✪ 𝐓𝐎 𝐘𝐎𝐔𝐑 𝐆𝐑𝐎𝐔𝐏 ➕️", url="t.me/RavanTheKaal_probot?startgroup=true"),
    ],
    [
...
RAVAN_IMG = "https://telegra.ph/file/b672c6aca34b320dd41c3.jpg"
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Ravanbot.modules." + module_name)
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text=""" Hi..🤗 I'm *RAVAN BOT*
                 \nSource code is private sorry  .""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=False,
            reply_markup=InlineKeyboardMarkup(
                [
