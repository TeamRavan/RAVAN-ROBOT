...
from Ravanbot import MONGO_DB_URI
from Ravanbot import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import Ravanbot.events

        path = Path(f"Ravanbot/modules/{shortname}.py")
        name = "Ravanbot.modules.{}".format(shortname)
        ...
        mod.Ravanbot = Ravanbot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["Ravanbot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Ravanbot/modules/*.py"
